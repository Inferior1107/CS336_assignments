...
\begin{problembox}{train\_bpe\_tinystories}{BPE Training on TinyStories \hfill (2 points)}
...
\begin{problembox}{train\_bpe\_expts\_owt}{BPE Training on OpenWebText \hfill (2 points)}
