...
\begin{enumerate}[itemsep=0pt, parsep=0pt, topsep=0pt]
    ...
    \item Transformer language model (LM) \hfill \tcbox[on line, boxsep=0pt, left=2pt, right=2pt, top=2pt, bottom=2pt, colback=green!10, colframe=green!50!black, fontupper=\tiny\bfseries]{DONE}
    \item The cross-entropy loss function and the AdamW optimizer \hfill \tcbox[on line, boxsep=0pt, left=2pt, right=2pt, top=2pt, bottom=2pt, colback=green!10, colframe=green!50!black, fontupper=\tiny\bfseries]{DONE}
...
\begin{enumerate}[itemsep=0pt, parsep=0pt, topsep=0pt]
    ...
    \item Run your trained tokenizer on the dataset to convert it into a sequence of integer IDs. \hfill \tcbox[on line, boxsep=0pt, left=2pt, right=2pt, top=2pt, bottom=2pt, colback=green!10, colframe=green!50!black, fontupper=\tiny\bfseries]{DONE}
